...
class ResnetBlock3D(nn.Module):
    ...
    def forward(self, input_tensor, temb):
        # print('resnet in', input_tensor.shape)
        ...
        if temb is not None and hidden_states.dim() == 4:
            temb = self.time_emb_proj(self.nonlinearity(temb))[:, :, None, None]
        elif temb is not None and hidden_states.dim() == 5:
        ...
        # output_tensor = big2small_image(output_tensor)
        # print('resnet out', output_tensor.shape)
